...
export default class reputationProductService {
  /** ==================== CREATE REPUTATION  =================== **/
  async createRepuServ(
  ...
  /** =================== DELETE REPUTATION  =================== **/
  async delRepuProductServ(pr_id: string) {
    return await daoRepuProduct.deleteReputation(pr_id);
  }

  /** ================= LIST REPUTATION  =============== **/

  async listRepuProductServ(product_id: string, page: number, size: number) {
    //check product:
