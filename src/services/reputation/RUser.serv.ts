...
export async function createReputationServ(
  tokenUid: string,
...
export async function deleteReputationServ(ur_id: string) {
  return await daoRepuUser.deleteReputationUser(ur_id);
}

/** ========================= GET REPUTATION BUYER ========================= **/
export async function ListRepuBuyerServ(
  user_id: string,
  page: number,
  size: number
) {
...
export async function listRepuSellerServ(
  user_id: string,
  page: number,
  size: number
) {
