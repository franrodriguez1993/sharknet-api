...
exports.superRouters = void 0;
const express_1 = require("express");
const fs_1 = require("fs");
const PATH_ROUTER = `${__dirname}`;
const superRouters = (0, express_1.Router)();
exports.superRouters = superRouters;
...
(0, fs_1.readdirSync)(PATH_ROUTER).filter((fileName) => {
    ...
    if (cleanName !== "index") {
        Promise.resolve().then(() => __importStar(require(`./${fileName}`))).then((moduleRouter) => {
            superRouters.use(`/api/v1/${cleanName}`, moduleRouter.router);
        });
    }
});
