...
exports.notificationtRouters = void 0;
const express_1 = require("express");
const fs_1 = require("fs");
const PATH_ROUTER = `${__dirname}`;
const notificationtRouters = (0, express_1.Router)();
exports.notificationtRouters = notificationtRouters;
...
(0, fs_1.readdirSync)(PATH_ROUTER).filter((fileName) => {
    ...
    if (cleanName !== "index") {
        Promise.resolve().then(() => __importStar(require(`./${fileName}`))).then((moduleRouter) => {
            notificationtRouters.use(`/api/v1/${cleanName}`, moduleRouter.router);
        });
    }
});
