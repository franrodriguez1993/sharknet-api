...
exports.reputationRouters = void 0;
const express_1 = require("express");
const fs_1 = require("fs");
const PATH_ROUTER = `${__dirname}`;
const reputationRouters = (0, express_1.Router)();
exports.reputationRouters = reputationRouters;
...
(0, fs_1.readdirSync)(PATH_ROUTER).filter((fileName) => {
    ...
    if (cleanName !== "index") {
        Promise.resolve().then(() => __importStar(require(`./${fileName}`))).then((moduleRouter) => {
            reputationRouters.use(`/api/v1/${cleanName}`, moduleRouter.router);
        });
    }
});
