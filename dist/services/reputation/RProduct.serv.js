...
exports.listRepuProductServ = exports.delRepuProductServ = exports.createRepuServ = void 0;
//uuid:
const uuid_1 = require("uuid");
//DAOs:
const containers_1 = require("../../containers");
/** ========================= CREATE REPUTATION  ========================= **/
function createRepuServ(tokenID, data) {
...
exports.createRepuServ = createRepuServ;
/** ========================= DELETE REPUTATION  ========================= **/
function delRepuProductServ(pr_id) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield containers_1.daoRepuProduct.deleteReputation(pr_id);
    });
}
exports.delRepuProductServ = delRepuProductServ;
/** ========================= LIST REPUTATION  ========================= **/
function listRepuProductServ(product_id, page, size) {
    return __awaiter(this, void 0, void 0, function* () {
        //check product:
...
exports.listRepuProductServ = listRepuProductServ;
